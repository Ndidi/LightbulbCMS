...
const Navbar = () => (
  ...
  <div className="container-nav w-container"><a href="index" className="logo-nav w-nav-brand" />
    <nav role="navigation" className="nav-menu-container w-nav-menu"><a href="index" className="nav-link w-hidden-main w-nav-link">Home</a><a href="what-is-data-storytelling" className="nav-link w-nav-link">Data Storytelling Platform</a>
